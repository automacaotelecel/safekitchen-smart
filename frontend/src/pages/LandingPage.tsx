          ...
          <div className="min-w-0 p-4 sm:p-5">
            ...
            <div className="mt-3 grid gap-3 sm:grid-cols-[1.25fr_.75fr]">
              ...
              <div className="rounded-2xl bg-[#073b4c] p-3 text-white">
                ...
                <p className="mt-3 text-[9px] font-black">Assistente inteligente</p>
                <p className="mt-1 text-[6px] font-semibold leading-relaxed text-white/60">Apoio para reconhecer produtos e organizar a rotina.</p>
      ...
      <main>
        ...
        <section className="px-4 pb-24 sm:px-6 sm:pb-32">
          <div className="mx-auto grid max-w-7xl overflow-hidden rounded-[34px] bg-[#073b4c] lg:grid-cols-[.95fr_1.05fr]">
            <div className="p-7 text-white sm:p-12 lg:p-16"><span className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-[#19d09c]/15 text-[#19f5c7]"><Bot size={23} /></span><p className="mt-7 text-xs font-black uppercase tracking-[0.22em] text-[#19f5c7]">Inteligência com responsabilidade</p><h2 className="mt-4 text-3xl font-black tracking-[-0.03em] sm:text-5xl">IA para apoiar. Sua equipe para decidir.</h2><p className="mt-6 text-base font-medium leading-7 text-white/65">A leitura inteligente ajuda a reconhecer informações e agilizar cadastros. Antes de salvar, a equipe confere e confirma os dados — porque automação útil também precisa de controle humano.</p><div className="mt-8 flex flex-wrap gap-3"><span className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs font-bold text-white/70">Conferência antes de salvar</span><span className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs font-bold text-white/70">Fallback de modelos</span><span className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs font-bold text-white/70">Histórico da operação</span></div></div>
