...
const schema = z.object({
  ...
  PLAN_START_SETUP_PRICE: z.coerce.number().positive().default(990),
  PLAN_START_MONTHLY_PRICE: z.coerce.number().positive().default(197),
  PLAN_PRO_SETUP_PRICE: z.coerce.number().positive().default(3700),
  PLAN_PRO_MONTHLY_PRICE: z.coerce.number().positive().default(497),
  ...
  CONTRACT_TERMS_VERSION: z.string().default('2026-07-23'),
...
export const env = {
  ...
  contractDeliveryDays: parsed.data.CONTRACT_DELIVERY_DAYS,
